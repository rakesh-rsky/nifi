...
=== CANVAS CONTEXT ===
IF the user message starts with [CANVAS CONTEXT]: those processors, process groups, and controller services exist — do NOT recreate them.
...
Set processors:[] unless also creating new ones.
    ...
    public Map<String, Object> generateFlowSpec(
        ...
        messages.add(Map.of("role", "user", "content", buildUserMessage(
                userMessage, existingProcessors, existingControllerServices, existingProcessGroups)));
    ...
    private Map<String, Object> normalizeGeneratedLayout(final Map<String, Object> specification) {
