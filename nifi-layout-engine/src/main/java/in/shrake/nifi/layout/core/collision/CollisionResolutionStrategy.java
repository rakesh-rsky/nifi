...
public interface CollisionResolutionStrategy {
    ...
    default CollisionResult resolve(List<PositionedComponent> components, LayoutOptions options, Set<String> fixedComponentIds) {
        return resolve(components, options);
    }
}
